...
def main():
    # 参数设置
    image_dir = 'phemetxt-image'  # 图片文件夹
    npy_dir1 = 'bert_phemetxt_prob_vectors'  # 第一个.npy文件夹
    npy_dir2 = 'BiLSTM_pheme/features'  # 第二个.npy文件夹
    batch_size = 32
    num_epochs = 100
    learning_rate = 0.001
    patience = 7
    ...
    # 测试模型
    print("Testing model...")
    test_metrics, test_preds, test_labels, test_features = test_model(model, test_loader)
